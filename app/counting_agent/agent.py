...
video_streaming_aget_tool = FunctionTool(
    func=monitor_video_stream,
    name="monitor_video_stream",
    description="Monitor how many people are in the video stream.",
    parameters={
        "type": "object",
        "properties": {
            "input_stream": {
                "title": "Input Stream",
                "description": "Video input stream to be monitored",
                "type": "object"
            }
        },
